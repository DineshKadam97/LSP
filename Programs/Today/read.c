// A program to demonstrate the failure cases of an read() system call using perror() function
...
int main(void)
{
	...
	{ 
		...
		perror("read");                     //// It will display the error, why we can not read the data
		return -1;
	}
